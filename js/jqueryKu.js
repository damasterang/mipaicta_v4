...
function point() {
	...
	switch (idPage) {
		case "spesifikasi":
		   ...
		   break;
		case "os1":
			target = 'processOs.php?kk=os1';
			break;
		case "os2":
			target = 'processOs.php?kk=os2';
			break;
		case "os3":
			target = 'processOs.php?kk=os3';
			break;
		case "os4":
			target = 'processOs.php?kk=os4';
			break;
		case "dualSim":
			target = 'processDualSim.php?kk=dualSim';
			break;
		case "kamera":
			target = 'processKamera.php?kk=kamera';
			break;
		case "harga1":
		...
		case "harga2":
			...
			break;
		case "harga3":
			target = 'processHarga.php?kk=harga3';
			break;
		case "harga4":
			target = 'processHarga.php?kk=harga4';
			break;
		case "harga5":
			target = 'processHarga.php?kk=harga5';
			break;
		case "harga6":
			target = 'processHarga.php?kk=harga6';
			break;
		case "harga7":
			target = 'processHarga.php?kk=harga7';
			break;
		case "harga8":
			target = 'processHarga.php?kk=harga8';
			break;
 	}
